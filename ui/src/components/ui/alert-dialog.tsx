  ...
  return (
    <AlertDialogPrimitive.Portal>
      ...
      <AlertDialogPrimitive.Content
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 gap-5 rounded-xl border bg-popover p-6 shadow-2xl outline-none",
          className,
        )}
        {...props}
      />
